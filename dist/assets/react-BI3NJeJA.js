...
function i() {
  ...
  ((S.constructor = m), _(S, g.prototype), (S.isPureReactComponent = !0));
  var b = Array.isArray,
    E = { H: null, A: null, T: null, S: null, V: null },
    O = Object.prototype.hasOwnProperty;
  function R(t, r, n, o, i, u) {
    return ((n = u.ref), { $$typeof: e, type: t, key: r, ref: void 0 !== n ? n : null, props: u });
  }
  function T(t) {
  ...
  function j(t, n, o, i, u) {
        ...
        case 'object':
          switch (t.$$typeof) {
            ...
            case r:
              ...
              break;
            case p:
              return j((a = t._init)(t._payload), n, o, i, u);
          }
      }
    if (a)
      return (
            ...
            (T(u) &&
              ...
              (c =
                ...
                (null == u.key || (t && t.key === u.key)
                  ...
                  : ('' + u.key).replace(C, '$&/') + '/') +
                a),
              (u = R(f.type, c, void 0, 0, 0, f.props))),
            n.push(u)),
        1
      );
    a = 0;
    var l,
      d = '' === i ? '.' : i + ':';
    if (b(t)) for (var _ = 0; _ < t.length; _++) a += j((i = t[_]), n, o, (s = d + w(i, _)), u);
    else if (
      'function' ==
      typeof (_ =
  ...
  return (
    ...
    (o.StrictMode = i),
    (o.Suspense = a),
    (o.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = E),
    ...
    (o.cloneElement = function (e, t, r) {
      ...
      var n = _({}, e.props),
        o = e.key;
      if (null != t)
        for (i in (void 0 !== t.ref && void 0, void 0 !== t.key && (o = '' + t.key), t))
          !O.call(t, i) ||
            'key' === i ||
            '__self' === i ||
            '__source' === i ||
      ...
      return R(e.type, o, void 0, 0, 0, n);
    }),
    ...
    (o.createElement = function (e, t, r) {
      ...
      if (null != t)
        for (n in (void 0 !== t.key && (i = '' + t.key), t))
          O.call(t, n) && 'key' !== n && '__self' !== n && '__source' !== n && (o[n] = t[n]);
    ...
    (o.startTransition = function (e) {
      ...
      try {
        var n = e(),
          o = E.S;
        (null !== o && o(r, n),
          'object' == typeof n && null !== n && 'function' == typeof n.then && n.then(N, P));
      } catch (i) {
        P(i);
      } finally {
        E.T = t;
    ...
    (o.useActionState = function (e, t, r) {
...
function u() {
  return (r || ((r = 1), (n.exports = i())), n.exports);
}
var s,
  f,
  c = { exports: {} },
...
function l() {
  ...
  return (
    (a.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = n),
    (a.createPortal = function (e, r) {
      var n = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : null;
      if (!r || (1 !== r.nodeType && 9 !== r.nodeType && 11 !== r.nodeType)) throw Error(t(299));
    ...
    (a.flushSync = function (e) {
      var t = i.T,
        r = n.p;
      try {
        if (((i.T = null), (n.p = 2), e)) return e();
      } finally {
        ((i.T = t), (n.p = r), n.d.f());
      }
    }),
    (a.preconnect = function (e, t) {
      'string' == typeof e &&
        (t
          ? (t =
    ...
    (a.prefetchDNS = function (e) {
      'string' == typeof e && n.d.D(e);
    }),
    (a.preinit = function (e, t) {
      if ('string' == typeof e && t && 'string' == typeof t.as) {
        ...
        'style' === r
          ? n.d.S(e, 'string' == typeof t.precedence ? t.precedence : void 0, {
              crossOrigin: o,
              integrity: i,
              fetchPriority: u,
            })
    ...
    (a.requestFormReset = function (e) {
      n.d.r(e);
    }),
    (a.unstable_batchedUpdates = function (e, t) {
      return e(t);
    }),
    (a.useFormState = function (e, t, r) {
